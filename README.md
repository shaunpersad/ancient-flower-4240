...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/ancient-flower-4240#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ancient-flower-4240
```

A live public deployment of this template is available at [https://ancient-flower-4240.templates.workers.dev](https://ancient-flower-4240.templates.workers.dev)
